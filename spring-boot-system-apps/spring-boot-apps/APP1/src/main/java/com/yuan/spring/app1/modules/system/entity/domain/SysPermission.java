...
public class SysPermission extends BaseEntity {
    ...
    public SysPermission(String id, String createBy, String updateBy, Date createDate, Date updateDate, String name, String nameSpellFull, String nameSpellSimple) {

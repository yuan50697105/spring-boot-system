package com.yuan.spring.boot.dao.hibernate.dao;
 ...
 **/
@NoRepositoryBean
public interface HibernateDao<T extends HibernateDomain<ID>, ID extends Serializable> extends JpaRepository<T, ID>, JpaSpecificationExecutor<T> {

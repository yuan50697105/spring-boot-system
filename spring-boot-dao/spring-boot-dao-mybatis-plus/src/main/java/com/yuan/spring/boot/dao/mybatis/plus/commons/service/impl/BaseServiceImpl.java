...
public abstract class BaseServiceImpl<M extends BaseDao<T, ID>, T extends BasePo<ID>, ID extends Serializable> extends ServiceImpl<M, T> implements BaseService<T, ID> {
